// Dialog for editing a session (name and group)
...
export function EditSessionDialog(props: EditSessionDialogProps) {
  ...
  createEffect(() => {
    if (props.session) {
      ...
      setGroupId(props.session.group_id || null);
    }
  });
